            ...
            <div className="edit-profile-wrapper">
                <div className="edit-profile-card">
                    ...
                    <div className="edit-profile-sidebar">
                        <div
                            className={`sidebar-item ${activeSection === 'profile' ? 'active' : 'off'}`}
                            onClick={() => setActiveSection('profile')}
                        >
                            프로필 편집
                        </div>
                        <div
                            className={`sidebar-item ${activeSection === 'password' ? 'active' : 'off'}`}
                            onClick={() => setActiveSection('password')}
                        >
                            비밀번호 변경
                        </div>
                        <div
                            className={`sidebar-item ${activeSection === 'apps' ? 'active' : 'off'}`}
                    ...
                    <div className="edit-profile-form">
                        ...
                        <div className={`form-section ${activeSection === 'profile' ? 'on' : 'off'}`}>
                            <div className="form-group photo-section">
                                <div className="photo-label-area">
                                    <img src={previewImage || getImageUrl(user.userAvatar)} alt="프로필 미리보기" />
                                </div>
                        ...
                        <div className={`form-section ${activeSection === 'password' ? 'on' : 'off'}`}>
                            <div className="form-group">
                                ...
                                />
                                <button className="edit-btn" onClick={handleCheckPassword}>
                                    확인
                                </button>
                            </div>
